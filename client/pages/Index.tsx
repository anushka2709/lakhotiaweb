export default function Index() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative h-screen bg-gradient-to-b from-slate-50 to-white flex items-center justify-center px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-8 inline-block">
            <div className="text-5xl font-bold text-slate-900 mb-4">
              LAKHOTIA
            </div>
            <div className="text-xl font-semibold text-slate-600 tracking-widest">
              INDUSTRIAL COMPLEX
            </div>
          </div>
      ...
      <section className="w-full py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Full-width Image */}
          <div className="w-screen relative left-[50%] right-[50%] -mx-[50vw] mb-0">
            <img
      ...
      <section className="py-16 md:py-24 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button className="bg-white hover:bg-blue-50 text-blue-600 font-semibold py-3 px-8 rounded-lg transition-colors">
            Get in Touch
          </button>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-slate-400">Industrial excellence meets sustainable growth</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-slate-400">
                <span className="block mb-2">Sanginhat Road</span>
                <span className="block mb-4">AMTA, West Bengal</span>
              </p>
            </div>
          </div>
